...
export const projects = [
  /* 
...

    {
      ...
      desc: 'Herramienta para remover el fondo de imágenes a través de la API de PhotoRoom, desarrollada en React. Contenido pre cacheado por el Service Worker para disminuír tiempo de carga. Se puede seleccionar un color de fondo',
